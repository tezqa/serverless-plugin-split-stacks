...
module.exports = {
  ...
  getStackNameBase(destination, destinationSuffix = 'NestedStack') {
    return `${destination}${destinationSuffix}`; //NestedStack`;
  },

  getStackName(destination, allowSuffix, destinationSuffix) {
    let stackNameBase = this.getStackNameBase(destination, destinationSuffix);
    let stackName;
    let suffix = '';
